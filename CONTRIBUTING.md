...
- Follow the [Project Constitution](.specify/memory/constitution.md) for documentation and technical standards.
- All Spec, Plan, Tasks, Checklist, and Analysis outputs must be in **Simplified Chinese**.
- Keep technical terms in English (React, Next.js, etc.).
- Use **Biome** for linting and formatting.
- Ensure changes are low-risk and rollback-capable.
